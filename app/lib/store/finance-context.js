...
export default function FinanceContextProvider({children}){
    ...
    const deleteExpenseCategory = async (expenseCategoryId) => {
      ...
      try{
        const docRef = await doc(db, "expenses", expenseCategoryId);
    ...
    const values = {income, expenses, addIncomeItem, removeIncomeItem, addExpenseItem, addExpenseItem, addCategory, deleteExpenseItem, deleteExpenseCategory}
    ...
    value={values}>{children}</FinanceContext.Provider>
    );
}